...
class TableViewController: SwipeTableController {
    ...
    @IBAction func addNewRoom(_ sender: Any) {
        let alertVC = PMAlertController(title: "新しい部屋を作る", description: "", image: UIImage(named: "img.png"), style: .alert)
        ...
        alertVC.addAction(PMAlertAction(title: "Create Room as question", style: .default, action: { () in
            ...
            if let roomName = newRoomNameField.text {
                ...
                let alertVC2 = PMAlertController(title: "部屋の種類をえ選びなさい", description: "", image: UIImage(named: "img.png"), style: .alert)
                
                alertVC2.addAction(PMAlertAction(title: "Create Room as question", style: .default, action: { () in
                ...
                alertVC2.addAction(PMAlertAction(title: "Create Room as assignment", style: .default, action: { () in
                ...
                alertVC2.addAction(PMAlertAction(title: "Create Room as assist", style: .default, action: { () in
        ...
        alertVC.addTextField { (textField) in
            textField?.placeholder = "部屋の名前を入力してください"
        }
